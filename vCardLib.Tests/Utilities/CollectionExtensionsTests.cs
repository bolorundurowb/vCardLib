...
{
    [Test]
    public void FilterInPlace_ValidInput_ShouldReturnItemsMatchingCondition()
    {
    ...
    [Test]
    public void FilterInPlace_CopyIsCreated_ShouldNotRemoveItemsFromOriginalCollection()
    {
