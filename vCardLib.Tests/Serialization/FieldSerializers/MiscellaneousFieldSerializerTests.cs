...
{
    [Test]
    public void AnniversaryFieldSerializer_WriteV4_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void BirthdayFieldSerializer_Write_ShouldReturnCorrectString()
    {
        var date = new DateTime(2000, 1, 1);
    ...
    [Test]
    public void GenderFieldSerializer_WriteV4_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void OrganizationFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void FormattedNameSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void CategoriesFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void MemberFieldSerializer_WriteV4_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void AgentFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void RevisionFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void UidFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void VersionFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void MailerFieldSerializer_WriteV2V3_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void CustomFieldSerializer_Write_ShouldReturnCorrectString()
    {
    ...
    [Test]
    public void KindSerializer_Write_ShouldReturnCorrectString()
    {
