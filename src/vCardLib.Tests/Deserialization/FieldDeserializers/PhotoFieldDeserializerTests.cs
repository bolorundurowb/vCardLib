...
public class PhotoFieldDeserializerTests
{
    ...
    [Test]
    public void Read_V2SimpleUrl_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V2WithEncodingAndImplicitType_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V2WithExplicitTypeParam_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V2DataUri_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V3WithBinaryEncoding_NormalizesToBase64()
    {
    ...
    [Test]
    public void Read_V3WithUriValue_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V3DataUri_ReturnsCorrectValue()
    {
        var rawData = "MIICajCCAdOgAwIBAgICBEUwDQYJKoZIhvcNAQEEBQA";
        var input = $"PHOTO:data:image/jpeg;base64,{rawData}";
        var result = ((IV3FieldDeserializer<Photo>)_deserializer).Read(input);
    ...
    [Test]
    public void Read_V4StandardUri_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V4DataUri_ReturnsCorrectValue()
    {
        var rawData = "MIICajCCAdOgAwIBAgICBEUwDQYJKoZIhvcNAQEEBQA";
        var input = $"PHOTO:data:image/jpeg;base64,{rawData}";
    ...
    [Test]
    public void Read_V4WithMediaTypeParameter_ReturnsCorrectValue()
    {
    ...
    [Test]
    public void Read_V4DataUri_StripsPrefixCorrectly()
    {
